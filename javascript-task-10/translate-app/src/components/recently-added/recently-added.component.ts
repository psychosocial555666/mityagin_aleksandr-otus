...
import { StoreService, WordItemType } from 'src/services/store/store.service';
...
export class RecentlyAddedComponent implements OnInit {
  words: WordItemType[] = []
  constructor(public storeService: StoreService, public wordsService: WordsService, public translateService: TranslateService) {}
  ngOnInit(): void {
