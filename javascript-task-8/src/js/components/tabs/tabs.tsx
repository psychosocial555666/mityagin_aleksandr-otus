...
import { IState, TabTypesType } from "../../types";
import { Dispatch } from "redux";

function Tabs(props: ITabsProps) {
  const { tabType, onTabButtonClick } = props;
      ...
      tabScreen = (
        <article className="services__item service">
          <div className="service__content">
            ...
            <a href="#more" className="service__button button">
              Узнать подробнее
            </a>
          </div>
        ...
        <article className="services__item service">
          <div className="service__content">
            ...
            <p className="service__description">
              Рассчитайте ежемесячный платеж <br />и ставку по кредиту
    ...
    <React.Fragment>
      <section className="services">
        <div className="services__controls">
          <button
            onClick={() => {
              onTabButtonClick(TabType.DEPOSITS as TabTypesType);
            }}
            className={
              tabType === TabType.DEPOSITS
                ? "services__control services__control--active"
                : "services__control"
            }
          >
          ...
          <button
            onClick={() => {
              onTabButtonClick(TabType.CREDITS as TabTypesType);
            }}
            className={
              tabType === TabType.CREDITS
                ? "services__control services__control--active"
                : "services__control"
            }
          >
          ...
          <button
            onClick={() => {
              onTabButtonClick(TabType.INSURANCE as TabTypesType);
            }}
            className={
              tabType === TabType.INSURANCE
                ? "services__control services__control--active"
                : "services__control"
            }
          >
          ...
          <button
            onClick={() => {
              onTabButtonClick(TabType.ONLINE as TabTypesType);
            }}
            className={
              tabType === TabType.ONLINE
                ? "services__control services__control--active"
                : "services__control"
            }
          >
        ...
        <div className="services__content">{tabScreen}</div>
      </section>
    </React.Fragment>
  );
}
